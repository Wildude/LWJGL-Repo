...
public class Test_5_10 extends Base{
    ...
    public void initialize()
    {
        ...
        Geometry labelGeo1 = new RectangleGeometry(600, 80, 
        new Vector(0,600), new Vector(0,1));
        Material labelMat1 = new TextureMaterial( 
        new Texture("images/crate-sim.png"));
        Mesh label1 = new Mesh(labelGeo1, labelMat1);
        hudScene.add( label1 );
        Geometry labelGeo2 = new RectangleGeometry(400, 80, new 
        Vector(800,0), new Vector(1,0));
        Material labelMat2 = new TextureMaterial( 
        new Texture("images/version-1.png"));
